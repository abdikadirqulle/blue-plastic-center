...
export function Toast({
  ...
  return (
    <div role={message.variant === "error" ? "alert" : "status"} aria-live="polite" className={cn("fixed right-4 top-[72px] z-[300] w-[min(390px,calc(100vw-2rem))] overflow-hidden rounded-xl border shadow-[0_14px_40px_rgba(15,42,58,0.18)] lg:right-6", style.frame)}>
