        ...
        <div role="dialog" aria-modal="true" aria-label={`Add new ${addNewLabel}`} onMouseDown={(event) => event.stopPropagation()} className="w-full max-w-lg rounded-2xl border border-[#dce6ed] bg-white shadow-[0_24px_80px_rgba(7,31,51,0.28)]">
          ...
          <div className="grid gap-4 p-5 sm:grid-cols-2">
            ...
            {quickAddKind === "account" ? (
              <label className="text-xs font-bold text-[#405762]"><span className="mb-1.5 block">Account type</span><Select value={accountType} onValueChange={setAccountType} options={[{ label: "Bank", value: "bank" }, { label: "Accounts receivable (A/R)", value: "accounts-receivable" }, { label: "Other current asset", value: "other-current-asset" }, { label: "Fixed asset", value: "fixed-asset" }, { label: "Other asset", value: "other-asset" }, { label: "Accounts payable (A/P)", value: "accounts-payable" }, { label: "Credit card", value: "credit-card" }, { label: "Other current liability", value: "other-current-liability" }, { label: "Long term liability", value: "long-term-liability" }, { label: "Equity", value: "equity" }, { label: "Income", value: "income" }, { label: "Other income", value: "other-income" }, { label: "Cost of goods sold", value: "cost-of-goods-sold" }, { label: "Expense", value: "expense" }, { label: "Other expense", value: "other-expense" }]} searchable={false}/></label>
            ) : null}
