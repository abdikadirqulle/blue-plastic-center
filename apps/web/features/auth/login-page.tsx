    ...
    <main className="grid min-h-screen bg-white lg:grid-cols-[1.05fr_0.95fr]">
      <section className="relative hidden overflow-hidden bg-[#071f33] p-12 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative flex items-center gap-3">
          <span className="grid size-11 place-items-center rounded-xl bg-[#007DCC]">
            <CircleDollarSign size={25} />
          </span>
          <div>
            <p className="text-lg font-bold">BLUE PLASTIC CENTER</p>
            <p className="text-xs text-[#9cb3c3]">Business system</p>
          </div>
        </div>
        <div className="relative max-w-xl">
          ...
          <p className="mt-6 max-w-lg text-base leading-7 text-[#b8c9d5]">
            Accounting, sales, purchasing, inventory, banking, projects,
            payroll, and reporting—connected in one secure workspace.
          </p>
          <div className="mt-10 grid grid-cols-3 gap-3">
            {[
              ...
              >
                ...
                <p className="mt-1 text-xs text-[#98afbf]">{label}</p>
              </div>
            ))}
          </div>
        </div>
        <p className="relative text-xs text-[#809aab]">
          © 2026 BLUE PLASTIC CENTER. Secure enterprise workspace.
        </p>
      </section>
      <section className="flex items-center justify-center p-5 sm:p-10">
        <div className="w-full max-w-md">
          <div className="mb-8 flex items-center gap-3 lg:hidden">
            <span className="grid size-10 place-items-center rounded-xl bg-[#007DCC] text-white">
              <CircleDollarSign size={23} />
            </span>
            <p className="text-lg font-bold">BLUE PLASTIC CENTER</p>
          </div>
          <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#007DCC]">
            Welcome back
          </p>
          <h2 className="mt-2 text-3xl font-bold tracking-[-0.04em] text-[#15303f]">
            Sign in to your workspace
          </h2>
          <p className="mt-2 text-sm text-[#758995]">
          ...
          >
            ...
            <label className="block">
              <div className="mb-1.5 flex justify-between">
                <span className="text-xs font-bold text-[#455e6b]">
                  Password
                </span>
                <button
                  type="button"
                  onClick={() =>
                    window.alert(
                      "Password reset will be enabled by an administrator.",
                    )
                  }
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-[#dce6ed] pl-10 pr-11 text-sm outline-none focus:border-[#007DCC] focus:ring-4 focus:ring-[#007DCC]/10"
                />
                <button
                  type="button"
                  aria-label={showPassword ? "Hide password" : "Show password"}
                  onClick={() => setShowPassword((value) => !value)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#6f8490]"
                >
            ...
            <label className="flex items-center gap-2 text-xs font-medium text-[#607681]">
              <input
                type="checkbox"
                defaultChecked
            ...
            <button
              disabled={loading}
              type="submit"
              className="h-12 w-full rounded-xl bg-[#007DCC] text-sm font-bold text-white shadow-lg shadow-sky-900/10 hover:bg-[#0069ad] disabled:opacity-70"
            >
              {loading ? "Signing in…" : "Sign in"}
            </button>
          </form>
          <p className="mt-6 text-center text-xs leading-5 text-[#83949e]">
            Protected by role-based access, audit logging, and encrypted
            sessions.
          </p>
        </div>
      </section>
