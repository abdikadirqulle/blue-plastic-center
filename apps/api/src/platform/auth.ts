...
const demoTokens: Record<string, Principal> = {
  "admin-demo-token": { userId: "00000000-0000-4000-8000-000000000001", name: "Abdikadir Qulle", role: "administrator" },
  "accountant-demo-token": { userId: "00000000-0000-4000-8000-000000000002", name: "Amina Yusuf", role: "accountant" },
  "viewer-demo-token": { userId: "00000000-0000-4000-8000-000000000003", name: "Read Only User", role: "viewer" },
};
...
export function authenticate(authorization?: string): Principal {
  ...
  if (!principal) throw new ApiError(401, "UNAUTHORIZED", "A valid bearer token is required");
  return principal;
}
