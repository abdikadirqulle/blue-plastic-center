...
async function seed() {
  ...
  for (const [
    ...
    await demo(id, "inventory", "items", "active", {
      sku,
      name,
      type: sku === "BPC-DELIVERY" ? "service" : "inventory",
      unit: "Each",
      salesDescription: name,
      salesPrice,
      purchaseCost,
      openingQuantity,
      incomeAccountId: accountId("4010"),
  ...
  > = [
    [
      ...
      "paid",
      {
        documentNumber: "SR-01001",
        customerId: customerData[3][0],
        saleDate: "2026-07-26",
        paymentMethod: "Cash",
        depositToAccountId: accountId("1000"),
        currency: "USD",
        total: "640.00",
        lines: [
          {
            itemId: itemData[2][0],
            description: "PET Bottle 1L",
            quantity: "500",
            unitPrice: "1.20",
          },
        ],
    ...
    [
      ...
      "paid",
      {
        documentNumber: "SR-01002",
        customerId: customerData[0][0],
        saleDate: "2026-07-27",
        paymentMethod: "Mobile money",
        depositToAccountId: accountId("1030"),
        currency: "USD",
        total: "925.00",
        lines: [
          {
            itemId: itemData[0][0],
            description: "HDPE Blue Container 25L",
            quantity: "50",
            unitPrice: "18.50",
          },
        ],
    ...
    [
      ...
      "applied",
      {
        documentNumber: "PAY-01001",
        customerId: customerData[0][0],
        paymentDate: "2026-07-20",
        amount: "2220.00",
        currency: "USD",
        depositToAccountId: accountId("1020"),
        paymentMethod: "Bank transfer",
        reference: "TRX-784521",
        allocations: [{ invoiceId: invoiceData[0][0], amount: "2220.00" }],
      },
    ],
    [
      ...
      "unapplied",
      {
        documentNumber: "PAY-01002",
        customerId: customerData[1][0],
    ...
    [
      ...
      "active",
      {
        displayName: "SomPolymer Supplies",
        companyName: "SomPolymer Supplies",
        email: "accounts@sompolymer.so",
        phone: "+252 61 555 2001",
        currency: "USD",
        openingBalance: "0",
      },
    ],
    [
      ...
      "active",
      {
        displayName: "Gulf Resin Trading",
        companyName: "Gulf Resin Trading",
        email: "finance@gulfresin.com",
        phone: "+971 50 555 2002",
        currency: "USD",
        openingBalance: "0",
      },
    ],
    [
      ...
      "open",
      {
        ...
        lines: [
          {
            accountId: accountId("5010"),
            description: "HDPE resin",
            quantity: "1",
            unitPrice: "12400.00",
          },
        ],
    ...
    [
      ...
      "paid",
      {
        documentNumber: "BILL-02002",
        vendorId: "53000000-0000-4000-8000-000000000002",
        billDate: "2026-06-28",
        dueDate: "2026-07-28",
        currency: "USD",
        total: "6850.00",
        balanceDue: "0",
        memo: "PET raw material",
      },
    ],
    [
      ...
      "active",
      {
        accountName: "Premier Operating Account",
        accountType: "Bank",
        bankName: "Premier Bank",
        accountNumber: "2048",
        currency: "USD",
        openingBalance: "284420.00",
        asOf: "2026-07-28",
        glAccount: accountId("1020"),
      },
    ],
    [
      ...
      "active",
      {
        accountName: "EVC Plus Collections",
        accountType: "Mobile money",
        bankName: "Hormuud",
        accountNumber: "7712",
        currency: "USD",
        openingBalance: "42680.00",
        asOf: "2026-07-28",
        glAccount: accountId("1030"),
      },
    ],
    [
      ...
      "active",
      {
        ...
        accountNumber: "PC-01",
        currency: "USD",
        openingBalance: "3850.00",
        asOf: "2026-07-28",
        glAccount: accountId("1010"),
      },
    ],
    [
      ...
      "cleared",
      {
        documentNumber: "BT-03001",
        account: "Premier Operating Account",
        type: "Deposit",
        date: "2026-07-20",
        payee: "Banaadir Trading Co.",
        reference: "TRX-784521",
    ...
    [
      ...
      "cleared",
      {
        documentNumber: "BT-03002",
        account: "Premier Operating Account",
        type: "Withdrawal",
        date: "2026-07-22",
        payee: "SomPolymer Supplies",
        reference: "WIRE-8821",
    ...
    [
      ...
      "open",
      {
        documentNumber: "AR-04001",
        customerId: customerData[1][0],
        invoiceId: invoiceData[1][0],
        dueDate: "2026-08-09",
        originalAmount: "2560.00",
        outstanding: "2560.00",
        agingBucket: "Current",
      },
    ],
    [
      ...
      "overdue",
      {
        documentNumber: "AR-04002",
        customerId: customerData[2][0],
        invoiceId: invoiceData[2][0],
        dueDate: "2026-07-15",
    ...
    [
      ...
      "open",
      {
        documentNumber: "AP-05001",
        vendorId: "53000000-0000-4000-8000-000000000001",
        billId: "54000000-0000-4000-8000-000000000001",
        dueDate: "2026-08-11",
  ...
  const notificationData: Array<[string, string, Record<string, unknown>]> = [
    [
      ...
      "unread",
      {
        title: "Invoice INV-01003 is overdue",
        message:
          "Horn Logistics has an outstanding balance of $1,800.00 requiring collection follow-up.",
        category: "Customers & Receivables",
        severity: "critical",
        href: `/sales/invoices/${invoiceData[2][0]}`,
        actionRequired: true,
    ...
    [
      ...
      "unread",
      {
        ...
        message:
          "Review stock availability and reorder requirements before confirming new sales orders.",
        category: "Inventory",
        severity: "warning",
        href: "/inventory/stock-levels",
        actionRequired: true,
        occurredAt: "2026-07-28T07:40:00.000Z",
        recipientUserId: userId,
        readAt: null,
      },
    ],
    [
      ...
      "unread",
      {
        title: "Vendor bill BILL-02001 is awaiting payment",
        message: "SomPolymer Supplies has $12,400.00 due on 11 Aug 2026.",
        category: "Vendors & Payables",
        severity: "warning",
        href: "/purchasing/bills/54000000-0000-4000-8000-000000000001",
        actionRequired: true,
        occurredAt: "2026-07-28T06:20:00.000Z",
        recipientUserId: userId,
        readAt: null,
      },
    ],
    [
      ...
      "read",
      {
        title: "Payment PAY-01001 was applied",
        message:
          "$2,220.00 from Banaadir Trading Co. was applied to INV-01001.",
        category: "Customers & Receivables",
        severity: "success",
        href: "/sales/payments/52000000-0000-4000-8000-000000000001",
        actionRequired: false,
        occurredAt: "2026-07-27T16:10:00.000Z",
        recipientUserId: userId,
        readAt: "2026-07-27T16:30:00.000Z",
      },
    ],
  ];
